...
class EvaluateProcess:
    ...
    def equations(self, process_inputs, optimization_variables, p):
        ...
        co2, h2o, naoh, magnesite, forsterite, fayalite, sio2 = optimization_variables[3:]
        ...
        pre_tear_stream[IDX['CO2']] = co2
        pre_tear_stream[IDX['H2O']] = h2o
        pre_tear_stream[IDX['NaOH']] = naoh
        pre_tear_stream[IDX['Magnesite']] = magnesite
        pre_tear_stream[IDX['Forsterite']] = forsterite
        pre_tear_stream[IDX['Fayalite']] = fayalite
        pre_tear_stream[IDX['Amorphous_Silica']] = sio2
