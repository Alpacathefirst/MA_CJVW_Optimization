...
class EvaluateProcess:
    ...
    def equations(self, process_inputs, optimization_variables, p):
        ...
        output_reactor, q_reactor, slr_eq, mol_eq = self.unit_handler.evaluate_reactor([output_heater, co2_in], t_reactor)
